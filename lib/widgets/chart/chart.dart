...
import 'package:expense1_tracker/widgets/chart/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseChart> get buckets {
    return [
      ...
      ExpenseChart.forCategory(expenses, Category.entertaiment),
      ExpenseChart.forCategory(expenses, Category.travel),
      ExpenseChart.forCategory(expenses, Category.work),
      ExpenseChart.forCategory(expenses, Category.transportation),
      ExpenseChart.forCategory(expenses, Category.housing),
    ];
  }
